...
def get_topography(
    ...
    **kwargs,
    ...
    """Return a Topography through the selected Pocketeer backend."""
    ...
    raise ValueError(
        f"Unknown Pocketeer backend {backend!r}. Supported: 'native', 'library'."
    )
...
def get_pockets(
    ...
    **kwargs,
    ...
    """Return Pocketeer-derived pocket features from the selected backend."""
