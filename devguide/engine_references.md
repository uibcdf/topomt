...
| `pocketeer` | Pocketeer project/method | `pocketeer` Python package | Pending explicit pin/documentation | Stable TopoMT integration and feature normalization | Reference not yet formalized |
